...
static INSTRUCTIONS: &'static [Instruction; 323] = &[
    ...
    Instruction::new(
        ...
        "JR {:#04x}",
        Some(Imm::Eight),
        Operation::Jr(Condition::Always, Source8::Imm8),
        vec![Clock::Twelve],
    ),
    Instruction::new(
        Opcode::ADD_HL_DE,
    ...
    Instruction::new(
        ...
        "JR NZ, {:#04x}",
        Some(Imm::Eight),
        Operation::Jr(Condition::NZ, Source8::Imm8),
    ...
    Instruction::new(
        ...
        "JR Z, {:#04x}",
        Some(Imm::Eight),
        Operation::Jr(Condition::Z, Source8::Imm8),
        vec![Clock::Twelve, Clock::Eight],
    ),
    Instruction::new(
        Opcode::ADD_HL_HL,
    ...
    Instruction::new(
       ...
       Instruction::new(
        ...
        "JR NC, {:#04x}",
        Some(Imm::Eight),
        Operation::Jr(Condition::NC, Source8::Imm8),
        vec![Clock::Twelve, Clock::Eight],
    ),
    Instruction::new(
        Opcode::LD_SP_d16,
    ...
    Instruction::new(
        ...
        "JR C, {:#04x}",
        Some(Imm::Eight),
        Operation::Jr(Condition::C, Source8::Imm8),
        vec![Clock::Twelve, Clock::Eight],
    ),
    Instruction::new(
        Opcode::ADD_HL_SP,
    ...
    Instruction::new(
        ...
        "JP NC, {:#06x}",
        Some(Imm::Sixteen),
        Operation::Jp(Conditon::NC, Source16::Imm16),
        vec![Clock::Sixteen, Clock::Twelve],
    ),
    Instruction::new(
        Opcode::CALL_NC_a16,
